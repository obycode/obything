...
definition(
    ...
    description: "Play a sound or custom message through your music device when the mode changes or other events occur.",
...
private takeAction(evt) {
    ...
    if (song) {
        ...
        sonos.playTrackAndRestore(state.sound.uri, state.sound.duration, volume, speakers)
    }
