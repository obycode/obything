...
definition(
    ...
    description: "Plays a selected playlist.",
...
preferences {
    page(name: "mainPage", title: "Play a selected playlist over your AirPlay speakers when something happens", nextPage: "chooseTrack", uninstall: true)
    page(name: "chooseTrack", title: "Select a playlist", install: true)
...
def chooseTrack() {
    dynamicPage(name: "chooseTrack") {
        section{
            input "song","enum",title:"Play this playlist", required:true, multiple: false, options: songOptions()
        }
...
private takeAction(evt) {
    ...
    if (volume) {
        ...
        sonos.playTrackOnSpeakers(state.selectedSong, speakers)
    }
    else {
